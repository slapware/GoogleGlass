...
class MySQL
{
	...
	public function __construct($connect = true, $database = null, $server = null,
		...
		$this->db_host    = $xml_config->database->db_host;  // server name
		$this->db_user    = $xml_config->database->db_username;       // user name
		$this->db_pass    = $xml_config->database->db_password;       // password
		$this->db_dbname  = $xml_config->database->db_name;           // database name
		$this->db_charset = $xml_config->database->db_charset;        // optional character set (i.e. utf8)
		// end slap add
