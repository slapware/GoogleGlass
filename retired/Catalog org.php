...
//		$this->setBase_catalog('http://openbook.harpercollins.com/api/v3/hcapim?apiname=catalog&format=XML&title=');
        ...
        *******************************************************************************/
        function getHtmlPage() {
        	if($this->getNotFound() == TRUE)
        	{
	        	...
	        	$this->speakable = 'I am very sorry, but I did not understand the name of the book you mentioned.';
	        	return;
            }
